...
export const Noise = {
  ...
  simplex1: function(xin) {
    return Noise.simplex2(xin, 0);
  },

  simplex1Range: function(xin, scale, min, max) {
  ...
  simplex2Range: function(xin, yin, scale, min, max) {
  ...
  simplex3Range: function(xin, yin, zin, scale, min, max) {
    return Num.map(Noise.simplex3(xin * scale, yin * scale, zin), -1, 1, min, max);
  },

  simplex: function(xin, yin, zin) {
    return Noise.simplex3(xin, yin, zin);
  },

  simplexRange: function(xin, yin, zin, scale, min, max) {
  ...
  perlin1Range: function(x, scale, min, max) {
  ...
  perlin2Range: function(x, y, scale, min, max) {
  ...
  perlin3Range: function(x, y, z, scale, min, max) {
  ...
  perlinRange: function(x, y, z, scale, min, max) {
    return Num.map(Noise.perlin3(x * scale, y * scale, z * scale), -1, 1, min, max);
  },
